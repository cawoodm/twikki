...
TWikki is designed to run in a browser, offline with cloud synch built-in. There is no backend, all libraries are cached in localStorage and updates are automatic.
...
What is special about twikki is that it's cloud-native - your data is stored in the cloud (wherever you choose) and synched to your browser which means it works offline. Whether you visit a web page hosting twikki or even just open a small .html file in your browser you can synch up your data and get started.

## Further Reading

Checkout our [docs](https://github.com/cawoodm/twikki/tree/main/docs).
