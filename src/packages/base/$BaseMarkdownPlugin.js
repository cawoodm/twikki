...
/**
 * $BaseMarkdownPlugin
 * Default markdown renderer for TWikki: the bundled markdown-it library
 * (minified, banner below) configured with html, linkify and typographer.
 * Registers the 'markdown.render' event handler the platform renders with.
 * Replace it from your own package with:
 *   `tw.events.override('markdown.render', function myMarkdown(text) {...});`
 * The markdown-it instance is exposed as tw.core.markdown.md for plugins
 * that extend it (e.g. [[$OpenLinksInNewWindow]] uses `md.use()`).
 */
...
!(function (t, e) {
  ...
  function zt(t) {
    ...
    for (let r = t.length - 1; r >= 0; r--) {
      const n = t[r];
      ('text' !== n.type || e || (n.content = n.content.replace(xt, vt)), 'link_open' === n.type && 'auto' === n.info && e--, 'link_close' === n.type && 'auto' === n.info && e++);
    }
  }
  function St(t) {
    let e = 0;
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      t: for (; a < l; ) {
        ...
        if (o.index - 1 >= 0) d = c.charCodeAt(o.index - 1);
          ...
          for (r = i - 1; r >= 0 && 'softbreak' !== t[r].type && 'hardbreak' !== t[r].type; r--)
            if (t[r].content) {
        ...
        if (a < l) _ = c.charCodeAt(a);
          ...
          for (r = i + 1; r < t.length && 'softbreak' !== t[r].type && 'hardbreak' !== t[r].type; r++)
            if (t[r].content) {
        ...
        const m = ct(d) || ut(d),
          ...
          D = it(_);
        if (
          (D ? (h = !1) : g && (k || m || (h = !1)), k ? (p = !1) : m && (D || g || (p = !1)), 34 === _ && '"' === o[0] && d >= 48 && d <= 57 && (p = h = !1), h && p && ((h = m), (p = g)), h || p)
        ) {
          if (p)
            for (r = n.length - 1; r >= 0; r--) {
              ...
              if (t.single === f && n[r].level === u) {
                let u, c;
                ((t = n[r]),
                  f ? ((u = e.md.options.quotes[2]), (c = e.md.options.quotes[3])) : ((u = e.md.options.quotes[0]), (c = e.md.options.quotes[1])),
                  Lt(s, i, o.index, c),
          ...
          h ? n.push({token: i, pos: o.index, single: f, level: u}) : p && f && Lt(s, i, o.index, '\u2019');
          ...
          for (let r = 0, n = e.length; r < n; r++) {
            ...
            for (let i = n.length - 1; i >= 0; i--) {
              ...
              if ('link_close' !== o.type) {
                if (('html_inline' === o.type && (Et(o.content) && s > 0 && s--, At(o.content) && s++), !(s > 0) && 'text' === o.type && t.md.linkify.test(o.content))) {
                  const s = o.content;
      ...
      function (t) {
        ...
        if (t.md.options.typographer)
          for (e = t.tokens.length - 1; e >= 0; e--)
            'inline' === t.tokens[e].type && (Ft.test(t.tokens[e].content) && zt(t.tokens[e].children), bt.test(t.tokens[e].content) && St(t.tokens[e].children));
      },
    ],
    [
      'smartquotes',
      function (t) {
        if (t.md.options.typographer) for (let e = t.tokens.length - 1; e >= 0; e--) 'inline' === t.tokens[e].type && qt.test(t.tokens[e].content) && It(t.tokens[e].children, t);
      },
    ],
    [
      'text_join',
  ...
  const Zt = '<[A-Za-z][A-Za-z0-9\\-]*(?:\\s+[a-zA-Z_:][a-zA-Z0-9:._-]*(?:\\s*=\\s*(?:[^"\'=<>`\\x00-\\x20]+|\'[^\']*\'|"[^"]*"))?)*\\s*\\/?>',
    $t = '<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>',
    Ut = new RegExp('^(?:' + Zt + '|' + $t + '|\x3c!---?>|\x3c!--(?:[^-]|-[^-]|--[^>])*--\x3e|<[?][\\s\\S]*?[?]>|<![A-Za-z][^>]*>|<!\\[CDATA\\[[\\s\\S]*?\\]\\]>)'),
    Ht = new RegExp('^(?:' + Zt + '|' + $t + ')'),
    Vt = [
  ...
  const Gt = [
    [
      ...
      function (t, e, r, n) {
        ...
        ((a = Pt(c)), a.length && '' === a[0] && a.shift(), a.length && '' === a[a.length - 1] && a.pop());
        const h = a.length;
        ...
        for (s = e + 2; s < r && !(t.sCount[s] < t.blkIndent); s++) {
          ...
          if (((a = Pt(c)), a.length && '' === a[0] && a.shift(), a.length && '' === a[a.length - 1] && a.pop(), (m += h - a.length), m > 65536)) break;
          if (s === e + 2) {
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        let l,
          ...
          p,
          f = !1;
        if ((n && 'paragraph' === t.parentType && t.sCount[c] >= t.blkIndent && (f = !0), (p = jt(t, c)) >= 0)) {
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        return !!g && (n || (void 0 === t.env.references && (t.env.references = {}), void 0 === t.env.references[g] && (t.env.references[g] = {title: _, href: h}), (t.line = o)), !0);
      },
    ],
    [
      'html_block',
      function (t, e, r, n) {
        ...
        const a = Vt[u][1].test('');
        if (!Vt[u][1].test(o))
          for (; c < r && (!(t.sCount[c] < t.blkIndent) || (!a && t.isEmpty(c))); c++)
            if (((s = t.bMarks[c] + t.tShift[c]), (i = t.eMarks[c]), (o = t.src.slice(s, i)), Vt[u][1].test(o))) {
              0 !== o.length && c++;
              break;
            }
        t.line = c;
        const l = t.push('html_block', '', 0);
        return ((l.map = [e, c]), (l.content = t.getLines(e, c, t.blkIndent, !0)), !0);
      },
      ['paragraph', 'reference', 'blockquote'],
    ],
    [
      ...
      function (t, e, r, n) {
        ...
        return ((l.content = ht(t.src.slice(s, i))), (l.map = [e, t.line]), (l.children = []), (t.push('heading_close', 'h' + String(u), -1).markup = '########'.slice(0, u)), !0);
      },
      ['paragraph', 'reference', 'blockquote'],
    ],
    [
  ...
  function Wt() {
    this.ruler = new gt();
    for (let t = 0; t < Gt.length; t++) this.ruler.push(Gt[t][0], Gt[t][1], {alt: (Gt[t][2] || []).slice()});
  }
  function Jt(t, e, r, n) {
    ((this.src = t),
      (this.env = r),
  ...
  ((Wt.prototype.tokenize = function (t, e, r) {
    ...
    (Jt.prototype.scanDelims = function (t, e) {
      ...
      let s;
      if (0 === t) s = 32;
      else if (1 === t) ((s = this.src.charCodeAt(0)), 55296 == (63488 & s) && (s = 65533));
      else if (((s = this.src.charCodeAt(t - 1)), 56320 == (64512 & s))) {
        const e = this.src.charCodeAt(t - 2);
        s = 55296 == (64512 & e) ? 65536 + ((e - 55296) << 10) + (s - 56320) : 65533;
      ...
      if (55296 == (64512 & u)) {
        ...
        u = 56320 == (64512 & t) ? 65536 + ((u - 55296) << 10) + (t - 56320) : 65533;
  ...
  var te = {
    tokenize: function (t, e) {
      ...
      for (let e = 0; e < i; e += 2)
        ((u = t.push('text', '', 0)), (u.content = o + o), t.delimiters.push({marker: n, length: 0, token: t.tokens.length - 1, end: -1, open: s.can_open, close: s.can_close}));
    ...
    postProcess: function (t) {
      ...
      Kt(t, t.delimiters);
      for (let n = 0; n < r; n++) e[n] && e[n].delimiters && Kt(t, e[n].delimiters);
    },
  };
  function ee(t, e) {
  ...
  var re = {
    tokenize: function (t, e) {
      ...
      for (let e = 0; e < s.length; e++) {
        ((t.push('text', '', 0).content = String.fromCharCode(n)), t.delimiters.push({marker: n, length: s.length, token: t.tokens.length - 1, end: -1, open: s.can_open, close: s.can_close}));
      }
      return ((t.pos += s.length), !0);
    },
    postProcess: function (t) {
      const e = t.tokens_meta,
        r = t.tokens_meta.length;
      ee(t, t.delimiters);
      for (let n = 0; n < r; n++) e[n] && e[n].delimiters && ee(t, e[n].delimiters);
    },
  };
  const ne = /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,
      ...
      [
        ...
        function (t, e) {
          ...
          if (!e) {
            ...
            (s < 256 && 0 !== Yt[s] ? (e.content = i) : (e.content = o), (e.markup = o), (e.info = 'escape'));
          }
          return ((t.pos = r + 1), !0);
        },
      ],
      ...
      [
        ...
        function (t, e) {
          ...
          if (a) {
            ...
            if (
              (d < h && 91 === t.src.charCodeAt(d) ? ((c = d + 1), (d = t.md.helpers.parseLinkLabel(t, d)), d >= 0 ? (n = t.src.slice(c, d++)) : (d = f + 1)) : (d = f + 1),
              n || (n = t.src.slice(p, f)),
      ...
      [
        ...
        function (t, e) {
          ...
          if (((i = d + 1), i < p && 40 === t.src.charCodeAt(i))) {
            ...
            if (i >= p) return !1;
            for (
              a = i, u = t.md.helpers.parseLinkDestination(t.src, i, t.posMax), u.ok && ((l = t.md.normalizeLink(u.str)), t.md.validateLink(l) ? (i = u.pos) : (l = '')), a = i;
              i < p && ((r = t.src.charCodeAt(i)), st(r) || 10 === r);
              i++
            );
            if (((u = t.md.helpers.parseLinkTitle(t.src, i, t.posMax)), i < p && a !== i && u.ok)) for (c = u.str, i = u.pos; i < p && ((r = t.src.charCodeAt(i)), st(r) || 10 === r); i++);
            else c = '';
            ...
            if (void 0 === t.env.references) return !1;
            if (
              (i < p && 91 === t.src.charCodeAt(i) ? ((a = i + 1), (i = t.md.helpers.parseLinkLabel(t, i)), i >= 0 ? (s = t.src.slice(a, i++)) : (i = d + 1)) : (i = d + 1),
              s || (s = t.src.slice(f, d)),
          ...
          if (35 === t.src.charCodeAt(r + 1)) {
            ...
            if (n) {
              if (!e) {
                ...
                ((r.content = H(e) ? V(e) : V(65533)), (r.markup = n[0]), (r.info = 'entity'));
              }
      ...
      [
        ...
        function (t) {
          const e = t.tokens_meta,
            r = t.tokens_meta.length;
          ue(t.delimiters);
          for (let t = 0; t < r; t++) e[t] && e[t].delimiters && ue(e[t].delimiters);
        },
      ],
  ...
  const me = {
          ...
          return (
            r.re.no_http ||
              (r.re.no_http = new RegExp(
                '^' + r.re.src_auth + '(?:localhost|(?:(?:' + r.re.src_domain + ')\\.)+' + r.re.src_domain_root + ')' + r.re.src_port + r.re.src_host_terminator + r.re.src_path,
                'i',
              )),
    ...
    ge = 'biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|\u0440\u0444'.split('|');
  function ke(t) {
  ...
  ((ye.prototype.add = function (t, e) {
      ...
      return (
        this.__opts__.fuzzyLink &&
          ...
          c >= 0 &&
            ...
            ((i = r.index + r[1].length), (this.__index__ < 0 || i < this.__index__) && ((this.__schema__ = ''), (this.__index__ = i), (this.__last_index__ = r.index + r[0].length)))),
        this.__opts__.fuzzyEmail &&
          ...
          a >= 0 &&
            ...
            (this.__index__ < 0 || i < this.__index__ || (i === this.__index__ && o > this.__last_index__)) && ((this.__schema__ = 'mailto:'), (this.__index__ = i), (this.__last_index__ = o)))),
        this.__index__ >= 0
      );
    }),
    ...
    (ye.prototype.match = function (t) {
      const e = [];
      let r = 0;
      this.__index__ >= 0 && this.__text_cache__ === t && (e.push(Ce(this, r)), (r = this.__last_index__));
      let n = r ? t.slice(r) : t;
      for (; this.test(n); ) (e.push(Ce(this, r)), (n = n.slice(this.__last_index__)), (r += this.__last_index__));
    ...
    (ye.prototype.matchAtStart = function (t) {
      ...
      return r ? ((this.__schema__ = e[2]), (this.__index__ = e.index + e[1].length), (this.__last_index__ = e.index + e[0].length + r), Ce(this, 0)) : null;
    }),
      ...
      return (
        ...
        e
          ? ((this.__tlds__ = this.__tlds__
            ...
            ke(this),
            this)
          : ((this.__tlds__ = t.slice()), (this.__tlds_replaced__ = !0), ke(this), this)
      );
    }),
  ...
  const Ee = 2147483647,
    ...
    Fe = /[^\0-\x7F]/,
    xe = /[\x2E\u3002\uFF0E\uFF61]/g,
    we = {overflow: 'Overflow: input needs wider integers to process', 'not-basic': 'Illegal input >= 0x80 (not a basic code point)', 'invalid-input': 'Invalid input'},
    ve = Math.floor,
  ...
  const Le = function (t) {
      return t >= 48 && t < 58 ? t - 48 + 26 : t >= 65 && t < 91 ? t - 65 : t >= 97 && t < 123 ? t - 97 : Ae;
    },
    Ie = function (t, e) {
    ...
    Me = function (t, e, r) {
      let n = 0;
      for (t = r ? ve(t / 700) : t >> 1, t += ve(t / e); t > 455; n += Ae) t = ve(t / 35);
    ...
    Te = function (t) {
      ...
      let n = 0,
        ...
        o = t.lastIndexOf('-');
      o < 0 && (o = 0);
      for (let r = 0; r < o; ++r) (t.charCodeAt(r) >= 128 && Se('not-basic'), e.push(t.charCodeAt(r)));
      for (let u = o > 0 ? o + 1 : 0; u < r; ) {
        const o = n;
        for (let e = 1, s = Ae; ; s += Ae) {
          u >= r && Se('invalid-input');
          const o = Le(t.charCodeAt(u++));
          (o >= Ae && Se('invalid-input'), o > ve((Ee - n) / e) && Se('overflow'), (n += o * e));
        ...
        const c = e.length + 1;
        ((i = Me(n - o, c, 0 == o)), ve(n / c) > Ee - s && Se('overflow'), (s += ve(n / c)), (n %= c), e.splice(n++, 0, s));
      }
    ...
    Re = function (t) {
      ...
      for (o && e.push('-'); u < r; ) {
        ...
        const c = u + 1;
        (r - n > ve((Ee - s) / c) && Se('overflow'), (s += (r - n) * c), (n = r));
        for (const r of t)
  ...
  return (
    ...
    (Ge.prototype.configure = function (t) {
      ...
      if (j(t)) {
        const e = t;
        if (!(t = Oe[e])) throw new Error('Wrong `markdown-it` preset "' + e + '", check name');
      }
...
(function () {
  return {
    ...
    init() {
      ...
      tw.core.markdown = {md, render: md.render.bind(md)};
