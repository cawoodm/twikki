...
!(function (t, e) {
  ...
  ((_t.code_inline = function (t, e, r, n, s) {
    ...
    (_t.image = function (t, e, r, n, s) {
      const i = t[e];
      return (
        (i.attrs[i.attrIndex('alt')][1] = s.renderInlineAsText(i.children, r, n)),
        s.renderToken(t, e, r)
      );
    }),
    ...
    (gt.prototype.before = function (t, e, r, n) {
      ...
      (this.__rules__.splice(s, 0, {name: e, enabled: !0, fn: r, alt: i.alt || []}),
        (this.__cache__ = null));
    }),
    (gt.prototype.after = function (t, e, r, n) {
      const s = this.__find__(t),
        i = n || {};
      if (-1 === s) throw new Error('Parser rule not found: ' + t);
      (this.__rules__.splice(s + 1, 0, {name: e, enabled: !0, fn: r, alt: i.alt || []}),
        (this.__cache__ = null));
    }),
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      t: for (; a < l; ) {
        ...
        if (a < l) _ = c.charCodeAt(a);
          ...
          for (
            r = i + 1;
            r < t.length && 'softbreak' !== t[r].type && 'hardbreak' !== t[r].type;
            r++
          )
            if (t[r].content) {
          ...
          if (p)
            for (r = n.length - 1; r >= 0; r--) {
              ...
              if (t.single === f && n[r].level === u) {
                ...
                ((t = n[r]),
                  f
                    ? ((u = e.md.options.quotes[2]), (c = e.md.options.quotes[3]))
                    : ((u = e.md.options.quotes[0]), (c = e.md.options.quotes[1])),
                  Lt(s, i, o.index, c),
  ...
  const Gt = [
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        if (t.listIndent >= 0 && t.sCount[c] - t.listIndent >= 4 && t.sCount[c] < t.blkIndent)
          return !1;
        let l,
          h,
          p,
          f = !1;
        if (
          (n && 'paragraph' === t.parentType && t.sCount[c] >= t.blkIndent && (f = !0),
          (p = jt(t, c)) >= 0)
        ) {
          if (
            ((l = !0),
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        for (
          s < i && d !== s && m.ok ? ((_ = m.str), (s = m.pos)) : ((_ = ''), (s = p), (o = f));
          s < i;
        ) {
  ...
  ((Wt.prototype.tokenize = function (t, e, r) {
    ...
    for (
      ;
      o < r && ((t.line = o = t.skipEmptyLines(o)), !(o >= r)) && !(t.sCount[o] < t.blkIndent);
    ) {
      if (t.level >= i) {
        t.line = r;
        break;
          ...
          if (((i = d + 1), i < p && 40 === t.src.charCodeAt(i))) {
            ...
            for (
              a = i,
                ...
                u.ok &&
                  ((l = t.md.normalizeLink(u.str)), t.md.validateLink(l) ? (i = u.pos) : (l = '')),
                a = i;
  ...
  ((ye.prototype.add = function (t, e) {
    ...
    (ye.prototype.match = function (t) {
      ...
      let n = r ? t.slice(r) : t;
      for (; this.test(n); )
        (e.push(Ce(this, r)), (n = n.slice(this.__last_index__)), (r += this.__last_index__));
